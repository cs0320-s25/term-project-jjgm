...
public class Server {
  ...
  public static void setUpServer() {
    ...
    try {
      ...
      // handlers for leaderboards
      Spark.get("/leaderboard/global", new leaderboardDormHandler(firebaseUtils));
      Spark.get("/leaderboard/dorm/:dormId", new leaderboardGlobalHandler(firebaseUtils));
